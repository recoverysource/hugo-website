...
\begin{document}
  ...
  \rotatebox{180}{\begin{minipage}[l][\dimexpr.485\textheight][t]{\dimexpr 0.470\textwidth}
    ...
    \vskip 1.5ex{\textbf{aamod-demo.recoverysource.io}}
...
{\7pt\textbf{Al-Anon Information:} al-anon.org}
  ...
  \begin{multicols}{4}
    ...
    {\7pt\textbf{Current:} https://aamod-demo.recoverysource.io/meeting-times}\\
    {\7pt\textbf{Events:} https://aamod-demo.recoverysource.io/events}\\
